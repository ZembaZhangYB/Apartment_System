...
public class FeeController {
    ...
    public Result saveOrUpdateFeeKey(@RequestBody FeeKey feeKey) {
        if(feeKeyService.saveOrUpdate(feeKey))  return Result.ok();
    ...
    public Result saveOrUpdateFeeValue(@RequestBody FeeValue feeValue) {
        if(feeValueService.saveOrUpdate(feeValue))  return Result.ok();
        else return Result.fail();
    }
    ...
    public Result deleteFeeKeyById(@RequestParam Long feeKeyId) {
        if(feeKeyService.deleteFeeKey(feeKeyId))  return Result.ok();
        else return Result.fail();
    }
    ...
    public Result deleteFeeValueById(@RequestParam Long id) {
        if (feeValueService.deleteFeeValue(id)) return Result.ok();
        else return Result.fail();
    }
}
